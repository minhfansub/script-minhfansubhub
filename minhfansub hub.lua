...
shared.LoaderTitle = "theo dõi:Minhfansub";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://130112450110381",
...
--     end
-- end);
local v14 = loadstring(game:HttpGet("https://raw.githubusercontent.com/minhfansub/script-minhfansubhub/refs/heads/main/main.lua"))();
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/cfZrN4bq7w");
    end
});
